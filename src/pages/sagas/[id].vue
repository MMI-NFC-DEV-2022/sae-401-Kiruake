...
defineProps <Database["public"]["Tables"]["sagas"]["Row"] & {films:Tables<'films'>[]} >()
...
<h1 class="text-3xl text-center lg:text-start text-gray-300 mt-20 lg:ml-10">Voici toute la saga {{saga.libelle }}
